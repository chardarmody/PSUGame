...
class GamePanel extends JPanel implements ActionListener{
    ...
    JButton CH1, GBGP, GB4, Q1, Q2, Q3, Q1A, Q1B, Q1C, Q1D, Q2A, Q2B, Q2C, Q2D, Q3A, Q3B, Q3C, Q3D, Q4A, Q4B, Q4C, Q4D;
    Timer tim;
...
// question one actionlistener events ****************************************************************************************************************************************************************************************************************************** 
          ...
          {
              repaint();
              Q1B.setBackground(Color.RED);
              Q1B.setForeground(Color.RED);
              Q1B.setText("WRONG");
              validate();
              repaint(); 
          }
          ...
          {
              repaint();
              Q1C.setBackground(Color.GREEN);
              Q1C.setForeground(Color.GREEN);
              Q1C.setText("CORRECT!!");
              validate();
              repaint();
          }
...
// ***************************************************************************************************************************************************************************************************************************** 
    ...
    public void GamePanel(){
        SwingUtilities.invokeLater(new Runnable(){
            @Override
            public void run(){
                new GamePanel(GB4).setVisible(true);
            }
        });
     }
